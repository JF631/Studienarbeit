...
longer than around seconds.\footnote{Approach length: 40 m, average run up speed:
...
%TODO%
%TODO: insert code from raspberry pi%

\subsubsection{Live-streaming the video feed}\label{subsubsec:4_live_stream}
...
athlete centered in the camera image.\\
