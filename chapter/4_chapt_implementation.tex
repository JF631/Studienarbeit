...
The \texttt{Parameterfile} class manages every access to all analysis parameters
which are saved for each jump video analysis.
All interactions that are supported can be seen in its' class diagram:
