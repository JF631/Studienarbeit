...
\ac{RPM} per input voltage.
As can be seen in \autoref{subfig:motor_picture}, the used Holybro motors are
capable of 920~\ac{RPM}.
As comparison, that is in the same area in which commercial hobby drones 
operate while race drones use motors that go up to 2000~\ac{RPM}.
