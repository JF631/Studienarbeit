...
Especially, the chosen programming language as well as the used Mediapipe
framework are discussed.
Moreover, some important Python modules are introduced.
...
As the work supports a wide range of software features, a variety of
